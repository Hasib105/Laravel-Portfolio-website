                        ...
                        <div class="col-lg-4 col-sm-6 mb-4">
                            ...
                            <div class="portfolio-item">
                                ...
                                <div class="portfolio-caption">
                                    ...
                                    <div class="portfolio-caption-subheading text-muted">{{$portfolio->catagory}}</div>
                                </div>
                            </div>
                        </div>
                        @endforeach
                        ...
                        <li>
                            ...
                            <div class="timeline-panel">
                                <div class="timeline-heading">
                                    <h4>{{$about->tilte1}}</h4>
                                    <h4 class="subheading">{{$about->tilte2}}</h4>
                                </div>
        ...
        <div class="portfolio-modal modal fade" id="portfolioModal1 <?php echo $portfolio->id ?>" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="close-modal" data-bs-dismiss="modal"><img src="{{url($portfolio->small_img)}}" alt="Close modal" /></div>
                    <div class="container">
